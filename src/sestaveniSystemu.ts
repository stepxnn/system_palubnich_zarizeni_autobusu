...
export function vytvorPalubniSystem() {
    ...
    const displejCestujici = new Displejcestujici(
        ...
        'Displej cestující',
        true,
        linka.zastavky[0],   // začínáme na první zastávce linky
        linka.zastavky,
        linka.cislo,
        new Date(),
        new Date()
    ...
    const palubniPocitac = new PalubniPocitac(
        validator,
        displejCestujici,
        dispecerKomunikace
    );
    ...
    return { linka, validator, displejCestujici, dispecerKomunikace, palubniPocitac };
}
